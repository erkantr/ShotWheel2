...
import com.agency11.shotwheel.databinding.HalkOylamasi2DialogBinding
...
class Dialogs(var context: Context) {
    ...
    fun getOylamaDialog(player: String, text: String, activity: Activity, game_point: Int) {
        ...
        val number1: TextView = window.findViewById(R.id.number1)
        val number2: TextView = window.findViewById(R.id.number2)
        val number3: TextView = window.findViewById(R.id.number3)
        val number4: TextView = window.findViewById(R.id.number4)
        val number5: TextView = window.findViewById(R.id.number5)
        val number6: TextView = window.findViewById(R.id.number6)
